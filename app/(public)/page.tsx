...
const TESTIMONIALS = [
  {
    ...
    text: 'O Vet.AI revolucionou como faço diagnósticos. A análise automática de exames me economiza horas de trabalho.',
    avatar: 'AP',
  },
  {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-teal-50/50 to-white dark:from-teal-950/20 dark:to-slate-950" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Reveal direction="up" delay={400}>
            <div className="mt-16 relative max-w-5xl mx-auto">
              <div className="absolute -inset-4 bg-gradient-to-r from-teal-500/20 via-emerald-500/20 to-teal-500/20 rounded-2xl blur-2xl" />
              <div className="relative rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl overflow-hidden">
                ...
                <div className="p-6 md:p-8 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            <div className="hidden md:block absolute top-16 left-1/6 right-1/6 h-0.5 bg-gradient-to-r from-teal-200 via-teal-400 to-teal-200 dark:from-teal-900 dark:via-teal-600 dark:to-teal-900" />
            ...
            {[
              ...
              <Reveal key={item.step} direction="up" delay={i * 150}>
                <div className="relative text-center">
                  <div className="relative z-10 inline-flex items-center justify-center w-16 h-16 rounded-full bg-teal-600 text-white text-xl font-bold mb-6 shadow-lg shadow-teal-500/30">
                    {item.step}
                  </div>
                  <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">
                    {item.title}
              ...
              <Reveal key={plan.name} direction="up" delay={i * 100}>
                <div
                  className={`relative rounded-2xl p-8 flex flex-col h-full ${
                    plan.highlighted
                      ? 'bg-gradient-to-b from-teal-600 to-teal-700 text-white shadow-xl shadow-teal-500/20 scale-105'
                  ...
                  <ul className="space-y-3 mb-8 flex-1">
                    {plan.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3">
                        <Check
                          size={18}
                          className={`mt-0.5 flex-shrink-0 ${plan.highlighted ? 'text-teal-200' : 'text-teal-600 dark:text-teal-400'}`}
                        />
                        <span
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal direction="up">
            <div className="relative rounded-2xl bg-gradient-to-r from-teal-600 to-emerald-600 p-10 md:p-16 text-center overflow-hidden">
              ...
              <div className="relative">
                <PawPrint size={48} className="text-white/80 mx-auto mb-6" />
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  Pronto para transformar sua clínica?
                </h2>
                <p className="text-teal-100 text-lg max-w-xl mx-auto mb-8">
                  Junte-se a milhares de veterinários que já usam IA para
                  oferecer o melhor cuidado aos seus pacientes.
                </p>
                <Link href="/register">
                  <Button
                    size="lg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <a
                href="#features"
                className="text-sm text-slate-500 dark:text-slate-400 hover:text-teal-600 transition-colors"
              >
                Funcionalidades
              </a>
              <a
            ...
            <p className="text-sm text-slate-400 dark:text-slate-500">
              &copy; 2026 Vet.AI. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>

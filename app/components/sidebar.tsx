    ...
    <>
      ...
      <aside className={`fixed md:relative w-64 flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 h-full z-40 transition-transform duration-300 ${
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-800">
          <button onClick={() => {}} className="flex items-center gap-3 px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg w-full">
            <LogOut size={18} /> Sair
          </button>
        </div>
      </aside>
